                      ...
                      {type === "luckmail" ? (
                        <>
                          <div className="space-y-2">
                            ...
                            <Input value={String(provider.project_code || "")} onChange={(event) => updateProvider(index, { project_code: event.target.value })} placeholder="openai" className="h-10 rounded-xl border-stone-200 bg-white" disabled={config.enabled} />
                          </div>
                          <div className="space-y-2">
